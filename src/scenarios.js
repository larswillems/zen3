  ...
  return {
    ...
    objects: [
      ...
      },
      {
        ...
        vx: 520.0348078072242,
        vy: -45.25260952589771,
        radius: 44,
        color: '#a78bfa',
        trail: true,
        trailLength: 24,
    ...
    events: [
      {
        id: 'timed_cycle',
        once: false,
        trigger: { type: 'everySeconds', seconds: 3 },
        actions: [
          { type: 'freezeBall' },
          { type: 'spawnBall', templateId: 'ball_1', jitter: 0 },
        ],
...
function buildPinballScenario(seed = 88, themeName = 'neon') {
  ...
  const objects = [];
  const wall = (id, x, y, armLength, rotation, color = '#38bdf8', thickness = 18) => {
    objects.push({
      id,
      type: 'spinner',
      x,
  ...
  wall('launch_lane_soft_return', 852, 1458, 190, Math.PI / 2 + 0.62, theme.wall, 14);
